...
def generate_launch_description():
    ...
    urdf = os.path.join(get_package_share_directory('kuka10'),'launch', 'kuka10.urdf'),
    ...
    return LaunchDescription([
        Node(package='controller_manager', executable='ros2_control_node',parameters=[urdf, ctrlr_param],
